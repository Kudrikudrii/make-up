...
const Gallery: React.FC = () => {
    ...
    return (
        ...
        >
            <GallerySection
                title="Фотосессии"
                description="Вместе с командой фотографа и стилиста, мы помогаем женщинам и мужчинам открыть себя заново. Мы создаём индивидуальные образы для фотосессий, чтобы вы почувствовали себя по-новому и увезли с собой не просто красивые фото, а новое ощущение себя."
